                ...
                <div class="col-lg-3">
                    <div class="left_sidebar_area">
                        <aside class="left_widgets p_filter_widgets">
                            ...
                            $query_kategori = "SELECT k.id_kategori, k.nm_kategori, COUNT(p.id_produk) AS jumlah_produk 
                            FROM tb_kategori k LEFT JOIN tb_produk p ON k.id_kategori = p.id_kategori GROUP BY k.id_kategori";
