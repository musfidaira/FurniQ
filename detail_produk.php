...
<head>
  ...
  <title>Detail Produk - FurniQ</title>
...
<body>
  ...
  $query = "SELECT p.nm_produk, p.harga, p.stok, p.desk, p.gambar, k.nm_kategori
    FROM tb_produk p JOIN tb_kategori k ON p.id_kategori = k.id_kategori
  ...
  if (isset($_POST['add_to_cart'])) {
    if (!isset($_SESSION['login'])) {
      ...
      if ($qty > $data_stok['stok']) {
        echo "<script>alert('Stok tidak mencukupi! Stok tersedia: {$data_stok['stok']}');
      </script>";
      } else {
        ...
        if ($koneksi->query($query_insert) === TRUE) {
          echo "<script>alert('Produk berhasil ditambahkan ke keranjang!'); window.location.href='belanja.php';
          </script>";
        } else {
  ...
  <section class="product_list best_seller">
    <div class="container">
      ...
      $query_produk_lain = "SELECT id_produk, nm_produk, harga, gambar FROM tb_produk WHERE
      id_produk != '$id_produk' LIMIT 5";
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | FurniQ by <a href="https://instagram.com/ffida.iraa/" target="_blank">Musfida Irawan Putri</a>
          ...
          <div class="col-lg-4">
            <div class="footer_icon social_icon">
              <ul class="list-unstyled">
                <li><a href="https://instagram.com/ffida.iraa/" class="single_social_icon"><i class="fab fa-instagram"></i></a></li>
              </ul>
            </div>
          </div>
        </div>
