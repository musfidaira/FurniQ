...
tb_produk.desk, tb_produk.gambar, tb_kategori.nm_kategori FROM tb_produk JOIN tb_kategori ON tb_produk.id_kategori = tb_kategori.id_kategori
...
$html = '<html>
<head>
    <title>Laporan Data per Kategori</title>
