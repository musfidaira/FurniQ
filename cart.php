      ...
      <div class="cart_inner">
        <div class="table-responsive">
          ...
          if (!isset($_SESSION['id_user'])) {
            echo "<script>alert('Silakan login terlebih dahulu!'); window.location='login.php';
          </script>";
          exit;
          }

          $id_user = $_SESSION['id_user']; // Ambil user_id dari sesi
          $query = "SELECT p.id_pesanan, pr.nm_produk, pr.harga, p.qty, (pr.harga * p.qty)
          AS total, pr.gambar FROM tb_pesanan p JOIN tb_produk pr ON p.id_produk = pr.id_produk
          JOIN tb_user u ON p.id_user = u.id_user WHERE u.id_user = '$id_user'";
            ...
            <table class="table">
              ...
              <tr>
                ...
                <td style="text-align: right;">
                  ...
                  Rp. <?php echo number_format($diskon, 0, ',', '.'); ?></h5>
                </td>
              </tr>
              <tr>
                <td colspan="3"></td>
